...
# API JSON: kwaivgi/kling-v2.1-i2v-standard.json
class KwaivgiKlingV2x1I2vStandard(BaseRequest):
    """
    Request class for Kwaivgi Kling V2.1 Image-to-Video Standard API
    """
    ...
    def get_api_path(self):
        ...
        return "/api/v3/kwaivgi/kling-v2.1-i2v-standard"
