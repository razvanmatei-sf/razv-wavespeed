...
# Node registration
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI WAN 2.5 Image-to-Video Fast": WAN25ImageToVideoFast
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI WAN 2.5 Image-to-Video Fast": "WaveSpeedAI WAN 2.5 Image-to-Video Fast"
}