...
# Node registration
NODE_CLASS_MAPPINGS = {
    "WaveSpeedAI OpenAI Sora 2 Text-to-Video": OpenAISora2TextToVideo
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "WaveSpeedAI OpenAI Sora 2 Text-to-Video": "WaveSpeedAI OpenAI Sora 2 Text-to-Video"
}
